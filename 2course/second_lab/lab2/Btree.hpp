...
namespace tree {
    ...
    void BTree<T>::insert(T key) {
        if (this->rootPtr == nullptr) {
            ...
            if (this->sequenceType == "ArraySequence") {
                newRootPtr->keys = new myarray::ArraySequence<T>();
                newRootPtr->childrenPointers = new myarray::ArraySequence<BNode<T> *>();
            } else {
    ...
    void BTree<T>::restructuring(BNode<T> *node) {
        ...
        if (this->sequenceType == "ArraySequence") {
            child1->keys = new myarray::ArraySequence<T>();
            child1->childrenPointers = new myarray::ArraySequence<BNode<T> *>();
        } else {
        ...
        if (this->sequenceType == "ArraySequence") {
            child2->keys = new myarray::ArraySequence<T>();
            child2->childrenPointers = new myarray::ArraySequence<BNode<T> *>();
        } else {
